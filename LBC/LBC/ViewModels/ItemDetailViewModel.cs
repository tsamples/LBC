...
namespace LBC.ViewModels
{
    public class ItemDetailViewModel : BaseViewModel
    {
        ...
        async Task ExecuteLoadItemCommand()
        {
            ...
            try
            {
                var page = await restDataStore.GetPageContent(this.Item.ContentId);
                this.Title = page.title.rendered;
                this.Html = "<html><head><base href=\"https://www.lakelandchurch.org\" /></head><body>" + page.content.rendered + "</body></html>";
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex);
